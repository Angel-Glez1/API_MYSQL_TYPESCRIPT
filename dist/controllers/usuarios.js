...
const getUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const usuarios = yield usuario_1.default.findAll({ where: { estado: 1 } });
...
const postUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { id, estado } = _a, data = __rest(_a, ["id", "estado"]);
    try {
        const issetEmail = yield usuario_1.default.findOne({ where: { email: data.email } });
        if (issetEmail) {
...
const putUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const issetEmail = yield usuario_1.default.findOne({ where: { email: body.email } });
        if (issetEmail) {
            return res.status(400).json({
                ok: false,
                msg: 'Las credenciales ya existen, intente con otras'
